...
def build_equation3_execution_step(route_entry: RouteEntry) -> ExecutionStep:
    ...
    notes = [
        "Equation Editor 3.0 has an internal limited MTEF v3 to canonical MathML path for supported script, root, fraction, bar, fence, matrix, and character structures."
    ]
